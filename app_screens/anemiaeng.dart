...
class AnemiaEng extends StatefulWidget {
  AnemiaEng({Key key}) : super(key: key);
  @override
  _SearchListState createState() => new _SearchListState();
}

class _SearchListState extends State<AnemiaEng> {
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              Container(
                  ...
                  child: Text(
                      "Anemia is a condition in which you lack enough healthy red blood cells to carry adequate oxygen to your body tissues. Anemia can make you feel tired and weak. Below remedies will help to improve the haemoglobin in thr blood cells.",
              ...
              Container(
                  ...
                  child: Text("  6. Irregular heartbeats",
                      textAlign: TextAlign.start,
                      style: GoogleFonts.oswald(fontSize: 20.0))),
              SizedBox(
                height: 10.0,
              ...
              Container(
                  ...
                  child: Text("  1. The vegetable that you can fully trust for curing your anaemia is beetroot. As this vegetable is enriched with natural iron, it helps in increasing the haemoglobin count in the blood. Hence, with prolonged consumption, the level of oxygen in the blood gradually increases.",
                      textAlign: TextAlign.start,
                      style: GoogleFonts.oswald(fontSize: 20.0))),
              SizedBox(
                height: 10.0,
              ...
              Container(
                  ...
                  child: Text("  2. It has been found that regular consumption of vitamin C has improved the conditions of patients suffering from acute anaemia. Consumptions of citrus fruits, like orange, sweet lime, or lemon are great sources of Vitamin C which helps the blood to absorb a greater quantity of iron.",
                      textAlign: TextAlign.start,
                      style: GoogleFonts.oswald(fontSize: 20.0))),
              SizedBox(
                height: 10.0,
              ...
              Container(
                  ...
                  child: Text("  3. Leafy green vegetables like spinach, is a natural source of vitamin B12, folic acid, and other vital nutrients, and shows its favourable effects very soon if you make it a part of your daily platter.",
                      textAlign: TextAlign.start,
                      style: GoogleFonts.oswald(fontSize: 20.0))),
              SizedBox(
                height: 10.0,
              ...
              Container(
                  ...
                  child: Text("  4. Raisins and dates are an excellent source of vitamin C and iron. Vitamin C helps to boost the immune system, thus helping your body to absorb iron more efficiently. Consuming a handful of soaked figs, and dates and raisins at least thrice a week in the morning can improve your haemoglobin levels.",
                      textAlign: TextAlign.start,
                      style: GoogleFonts.oswald(fontSize: 20.0))),
              SizedBox(
                height: 10.0,
